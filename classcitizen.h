...
public:
    // Constructor
    classCitizen(QString name, QString contactNumber, QString emailAddress, QString dateOfBirth, QString nhi, QString guardian, QString additionalNotes, QString vaccineStatus, QString cvn); // , QString accessNumber
